...
import com.takin.emmet.algo.Stack;
...
public class AVLTree<T extends Comparable<? super T>> implements SearchTree<T> {
    ...
    public T getCommonParent(T one, T other) {
        ...
        if (one_node == null || other_node == null)
            return null;
    ...
    public String toString() {
        com.takin.emmet.algo.string.StringBuilder sb = new com.takin.emmet.algo.string.StringBuilder("AVLTree");
        sb.add('[');
        for (T ele : this) {
