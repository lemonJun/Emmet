...
class FixedDelayRegistration<T> extends OneShotRegistration<T> {
    ...
    public FixedDelayRegistration(int rounds, Callable<T> callable, long delay, int scheduleRounds, int scheduleOffset, Consumer<Registration<?>> rescheduleCallback) {
