...
public class LockFreeDeque<E> extends AbstractQueue<E> implements Deque<E> {
     ...
     */
    private AtomicReference<AnchorType<E>> anchor = new AtomicReference<AnchorType<E>>(new AnchorType<E>());
    ...
    public void addFirst(E d) {
        ...
        while (true) {
            ...
            if (old_anchor.right == null) // deque is empty
            {
                 ...
                 */
                update_anchor.setup(newtop, old_anchor.left, RPUSH, old_anchor.numElements + 1);
                /*
    ...
    public E pollFirst() {
        ...
        while (true) {
            ...
            if (old_anchor.right == old_anchor.left) {
                 ...
                 */
                new_anchor.setup(prevNode, old_anchor.left, old_anchor.status, old_anchor.numElements - 1);
                /*
    ...
    public void addLast(E d) {
        ...
        while (true) {
            ...
            if (old_anchor.left == null) // deque is empty
            {
                 ...
                 * the new node
                 */
                update_anchor.setup(old_anchor.right, newtop, LPUSH, old_anchor.numElements + 1);
    ...
    public E pollLast() {
        ...
        while (true) {
            ...
            if (oldAnchor.right == oldAnchor.left) {
                 ...
                 */
                newAnchor.setup(oldAnchor.right, prev, oldAnchor.status, oldAnchor.numElements - 1);
                /*
