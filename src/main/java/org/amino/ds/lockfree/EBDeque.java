    ...
    public void addFirst(E d) {
        ...
        while (true) {
            ...
            if (oanchor.right == null) // deque is empty
            {
                ...
                nanchor.setup(newtop, oanchor.left, RPUSH, oanchor.numElements + 1);
                /**
    ...
    public E pollFirst() {
        ...
        while (true) {
            ...
            if (oanchor.right == oanchor.left) {
                ...
                nanchor.setup(prev, oanchor.left, oanchor.status, oanchor.numElements - 1);
    ...
    public void addLast(E d) {
        ...
        while (true) {
            ...
            if (oanchor.left == null) {
                ...
                nanchor.setup(oanchor.right, newtop, LPUSH, oanchor.numElements + 1);
    ...
    public E pollLast() {
        ...
        while (true) {
            ...
            if (oanchor.right == oanchor.left) {
                ...
                nanchor.setup(oanchor.right, prev, oanchor.status, oanchor.numElements - 1);
                if (anchor.compareAndSet(oanchor, nanchor)) {
